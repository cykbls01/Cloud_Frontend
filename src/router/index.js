...
const router = new Router({
  routes: [
    ...
    },
    {
      ...
      component: () => import('../views/common/projectContainer.vue')
    },
    {
      path: '/student/expVM',
      name: 'expVM',
    ...
    {
      path: '/student/containerManagement',
      name: 'stuContainerManagement',
      component: () => import('../views/student/containerManagement')
    },
    {
      path: '/admin/containerManagement',
      name: 'adminContainerManagement',
      component: () => import('../views/admin/containerManagement')
    },
    {
      path: '/teacher/containerManagement',
      name: 'teaContainerManagement',
      component: () => import('../views/teacher/containerManagement')
    },
    {
      path: '/teacher/teacherProjectManagement',
      name: 'teacherProjectManagement',
      component: () => import('../views/teacher/teacherProjectManagement')
    },
    {
      path: '/student/studentProjectManagement',
      name: 'studentProjectManagement',
      component: () => import('../views/student/studentProjectManagement')
    },
    {
      path: '/all/skydrive',
      name: 'skydrive',
