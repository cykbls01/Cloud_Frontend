...
<!--        <Icon type="md-apps" size="81"></Icon>-->
        <img class="logo-img" src="../assets/img/school_logo_white.png" />
      </div>
...
export default {
  ...
  data () {
    return {
      ...
      studentMenu: [
        {name: 'item1', title: '实验信息', icon: '', path: '/student/experiments'},
        {name: 'item2', title: '虚拟机管理', path: '/student/vmManagement'},
        {name: 'item3', title: '实验虚拟机', path: '/student/expVM'},
        {name: 'item4', title: '容器管理', path: '/student/containerManagement'},
        {name: 'item5', title: '项目管理', path: '/student/studentProjectManagement'},
        {name: 'item6', title: '申请记录', path: '/student/applicationInfo'},
        {name: 'item7', title: '课程管理', path: '/assistant/courseManagement'},
        {name: 'itme8', title: '应用中心', path: '/security/index'}
      ],
      teacherMenu: [
        {name: 'item1', title: '课程管理', path: '/teacher/course'},
        {name: 'item2', title: '虚拟机管理', path: '/teacher/vm'},
        {name: 'item3', title: '模板管理', path: '/teacher/template'},
        {name: 'item4', title: '容器管理', path: '/teacher/containerManagement'},
        {name: 'item5', title: '项目管理', path: '/teacher/teacherProjectManagement'},
        {name: 'item6', title: '申请记录', path: '/teacher/applicationInfo'},
        {name: 'item7', title: '课程团队', path: '/teacher/assistant'},
        {name: 'itme8', title: '应用中心', path: '/security/index'}
      ],
      personnel: [
      ...
      adminMenu: [
        ...
        {name: 'item6', title: '容器管理', path: '/admin/containerManagement'},
